...
scaffold_name: <resolved temporary scaffold directory name, or "." for native-cwd>
...
**Temporary scaffold cleanup**: `<scaffold_name> deleted` or `<scaffold_name> left in place (failure)`
```
...
**Temporary scaffold left in place at**: `<scaffold_name>/`
```
