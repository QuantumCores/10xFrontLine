...
- [ ] 1.2 Capacitor sync completes from `src/mbl`: `npx cap sync android`
- [ ] 1.3 Android project is present after generation: `src/mbl/android`

#### Manual

- [ ] 1.4 Developer can open or run the Android project locally with Capacitor tooling
- [ ] 1.5 Capacitor config points to the actual Angular build output and not a stale folder
- [ ] 1.6 No production signing secrets or Play Console configuration are introduced
