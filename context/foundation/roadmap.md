...
|---|---|---|---|---|---|
| F-01 | f-01-minimal-authenticated-result-contract | (foundation) passwordless identity and a completed-result write contract are ready for the first match flow | - | FR-001, FR-010, Access Control | ready |
| S-01 | s-01-first-saved-frontline-match | signed-in player can complete the first saved frontline match against an automated NPC | F-01 | US-01, FR-001, FR-002, FR-003, FR-004, FR-005, FR-006, FR-007, FR-008, FR-009, FR-010 | proposed |
| S-02 | s-02-clear-match-feedback | player can clearly read build progress, send feedback, and frontline pressure during a match | S-01 | US-01, FR-002, FR-004, FR-005, FR-008 | proposed |
| S-03 | s-03-resilient-result-sync | player can complete a match during temporary network loss without losing the result | F-01, S-01 | US-01, FR-010 | proposed |
| S-04 | s-04-restart-completed-match | player can restart after a completed match | S-01 | US-01, FR-011 | proposed |
...
- **Change ID:** f-01-minimal-authenticated-result-contract
...
- **Change ID:** s-01-first-saved-frontline-match
...
- **Change ID:** s-02-clear-match-feedback
...
- **Change ID:** s-03-resilient-result-sync
...
- **Change ID:** s-04-restart-completed-match
...
|---|---|---|---|---|
| F-01 | f-01-minimal-authenticated-result-contract | Establish minimal authenticated result contract | yes | Run `/10x-plan f-01-minimal-authenticated-result-contract`; this unlocks S-01. |
| S-01 | s-01-first-saved-frontline-match | Build the first saved frontline match | no | Depends on F-01. |
| S-02 | s-02-clear-match-feedback | Make match feedback clear during play | no | Depends on S-01. |
| S-03 | s-03-resilient-result-sync | Preserve completed results during temporary network loss | no | Depends on F-01 and S-01. |
| S-04 | s-04-restart-completed-match | Add restart after completed match | no | Depends on S-01. |
